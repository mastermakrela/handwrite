...
const PUNCT_NAMES: Record<string, string> = {
  ...
  "@": "at", "/": "slash", "&": "ampersand", "#": "numbersign", "%": "percent",
};
...
export const CHAR_GROUPS: CharGroup[] = [
  { id: "lower", label: "a – z", on: true, chars: [..."abcdefghijklmnopqrstuvwxyz"].map((x) => c(x)) },
  { id: "upper", label: "A – Z", on: true, chars: [..."ABCDEFGHIJKLMNOPQRSTUVWXYZ"].map((x) => c(x)) },
  { id: "digits", label: "0 – 9", on: true, chars: [..."0123456789"].map((x) => c(x)) },
  { id: "punct", label: "punctuation", on: true, chars: [".", ",", "!", "?", "'", '"', "-", ":", ";", "(", ")"].map((x) => c(x)) },
  {
    id: "german", label: "German", on: false,
    chars: [
      c("ä", "adieresis"), c("ö", "odieresis"), c("ü", "udieresis"),
      c("Ä", "Adieresis"), c("Ö", "Odieresis"), c("Ü", "Udieresis"), c("ß", "germandbls"),
    ],
  },
  {
    id: "polish", label: "Polish", on: false,
    chars: [
      c("ą", "aogonek"), c("ć", "cacute"), c("ę", "eogonek"), c("ł", "lslash"), c("ń", "nacute"),
      c("ó", "oacute"), c("ś", "sacute"), c("ź", "zacute"), c("ż", "zdotaccent"),
      c("Ą", "Aogonek"), c("Ć", "Cacute"), c("Ę", "Eogonek"), c("Ł", "Lslash"), c("Ń", "Nacute"),
      c("Ó", "Oacute"), c("Ś", "Sacute"), c("Ź", "Zacute"), c("Ż", "Zdotaccent"),
    ],
  },
